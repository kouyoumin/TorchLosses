...
class DiceLoss(nn.Module):
    ...
    def __init__(self, dim=(2,3), pos_weight=1., neg_weight=0., class_weight=None, mode='pos_only', ignore_empty=True, ignore_full=True, eps=1e-8, exp=1., reduction='none', verbose=False):
